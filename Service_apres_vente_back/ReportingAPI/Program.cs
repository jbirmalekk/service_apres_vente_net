...
builder.Services.AddDbContext<ReportingAPIContext>(options => options.UseSqlServer(connectionString));
...
{
    var dbContext = scope.ServiceProvider.GetRequiredService<ReportingAPIContext>();
