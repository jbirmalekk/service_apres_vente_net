...
builder.Services.AddDbContext<NotificationAPIContext>(options => options.UseSqlServer(connectionString));
...
{
    var dbContext = scope.ServiceProvider.GetRequiredService<NotificationAPIContext>();
